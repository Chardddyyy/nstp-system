          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 relative z-10 w-full">
            <div className="flex items-center space-x-3 sm:space-x-4 min-w-0 flex-1 w-full">
              ...
              <div className="min-w-0 flex-1">
                <h2 className="text-lg sm:text-2xl lg:text-3xl font-black tracking-tight text-white truncate">{user?.department} Instructor Portal</h2>
                <p className="text-emerald-200 text-xs sm:text-base font-medium truncate mt-0.5">Welcome back, {user?.name || 'Instructor'} 👋</p>
              </div>
            </div>
