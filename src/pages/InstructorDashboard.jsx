          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-2.5 sm:gap-3 relative z-10 w-full">
            <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1 w-full">
              ...
              <div className="min-w-0 flex-1">
                <h2 className="text-xs sm:text-xl lg:text-2xl font-black tracking-tight text-white truncate">{user?.department} Instructor Portal</h2>
                <p className="text-emerald-200 text-[10px] sm:text-xs lg:text-sm font-medium truncate mt-0.5">Welcome back, {user?.name || 'Instructor'} 👋</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
              ...
              {/* User Profile Button - Displays Avatar, Name & Role on Mobile */}
              <Link 
                to="/profile" 
              ...
              >
                ...
                <div className="block text-left min-w-0 overflow-hidden">
                  <p className="font-bold text-[9px] sm:text-xs text-white leading-tight truncate max-w-[70px] sm:max-w-none">{user?.name || 'Instructor'}</p>
                  <p className="text-[7px] sm:text-[10px] text-amber-300 font-semibold uppercase tracking-wider truncate">{user?.department} Instructor</p>
                </div>
              </Link>
            </div>
          </div>
