          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-2.5 sm:gap-3 relative z-10 w-full">
            <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1 w-full">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="text-xs sm:text-xl lg:text-2xl font-black tracking-tight text-white truncate">Letter Formats &amp; Attachments</h1>
                <p className="text-emerald-200 text-[10px] sm:text-xs lg:text-sm font-medium truncate mt-0.5">Download or upload official forms for ROTC, CWTS, and LTS</p>
              </div>
            </div>
