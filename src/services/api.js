...
export const DEFAULT_PAST_BATCHES = [
  {
    ...
    data: {
      ...
      startMonth: '2023-08',
      endMonth: '2023-12',
      studentData: generateArchivedStudents(2023, '1st Semester', 8, 8, 8),
      reportData: [
        { 
          id: 101, 
  ...
  },
  {
    ...
    data: {
      ...
      startMonth: '2024-01',
      endMonth: '2024-05',
      studentData: generateArchivedStudents(2023, '2nd Semester', 6, 7, 7),
      reportData: [
        { 
          id: 201, 
  ...
  },
  {
    ...
    data: {
      ...
      startMonth: '2024-08',
      endMonth: '2024-12',
      studentData: generateArchivedStudents(2024, '1st Semester', 10, 8, 8),
      reportData: [
        { 
          id: 301, 
  ...
  },
  {
    ...
    data: {
      ...
      startMonth: '2025-01',
      endMonth: '2025-05',
      studentData: generateArchivedStudents(2024, '2nd Semester', 7, 7, 7),
      reportData: [
        { 
          id: 401, 
  ...
  },
  {
    ...
    data: {
      ...
      startMonth: '2025-08',
      endMonth: '2025-12',
      studentData: generateArchivedStudents(2025, '1st Semester', 10, 8, 8),
      reportData: [
        { 
          id: 501, 
  ...
  },
  {
    ...
    data: {
      ...
      startMonth: '2026-01',
      endMonth: '2026-05',
      studentData: generateArchivedStudents(2025, '2nd Semester', 7, 7, 7),
      reportData: [
        { 
          id: 601, 
