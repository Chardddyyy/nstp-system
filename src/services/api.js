...
const DEFAULT_PAST_BATCHES = [
  {
    ...
    reports: 3,
    data: {
      studentData: RAW_STUDENTS_2023.map(s => ({ ...s, semester: '1st Semester' })),
      reportData: [
        { id: 1, title: 'NSTP 1 Community Orientation & Immersion Plan (2023-2024 1st Sem)', department: 'CWTS', status: 'Approved', submittedAt: '2023-11-15' },
        { id: 2, title: 'Literacy Pre-Assessment & Needs Survey (2023-2024 1st Sem)', department: 'LTS', status: 'Approved', submittedAt: '2023-11-16' },
        { id: 3, title: 'Basic Military Training Briefing (2023-2024 1st Sem)', department: 'ROTC', status: 'Approved', submittedAt: '2023-11-17' }
      ]
    }
  },
  {
    ...
    reports: 3,
    data: {
      studentData: RAW_STUDENTS_2023.map(s => ({ ...s, semester: '2nd Semester' })),
      reportData: [
        { id: 1, title: 'Final Community Outreach & Tree Planting (2023-2024 2nd Sem)', department: 'CWTS', status: 'Approved', submittedAt: '2024-04-15' },
        { id: 2, title: 'Literacy Tutorial Graduation Documentation (2023-2024 2nd Sem)', department: 'LTS', status: 'Approved', submittedAt: '2024-04-16' },
        { id: 3, title: 'Annual ROTC Tactical Briefing & Muster (2023-2024 2nd Sem)', department: 'ROTC', status: 'Approved', submittedAt: '2024-04-17' }
      ]
    }
  },
  {
    ...
    reports: 3,
    data: {
      studentData: RAW_STUDENTS_2024.map(s => ({ ...s, semester: '1st Semester' })),
      reportData: [
        { id: 1, title: 'NSTP 1 Community Orientation (2024-2025 1st Sem)', department: 'CWTS', status: 'Approved', submittedAt: '2024-11-15' },
        { id: 2, title: 'Literacy Readiness Documentation (2024-2025 1st Sem)', department: 'LTS', status: 'Approved', submittedAt: '2024-11-16' },
        { id: 3, title: 'ROTC Formation & Field Exercises (2024-2025 1st Sem)', department: 'ROTC', status: 'Approved', submittedAt: '2024-11-17' }
      ]
    }
  },
  {
    ...
    reports: 3,
    data: {
      studentData: RAW_STUDENTS_2024.map(s => ({ ...s, semester: '2nd Semester' })),
      reportData: [
        { id: 1, title: 'Final NSTP Community Service Report (2024-2025 2nd Sem)', department: 'CWTS', status: 'Approved', submittedAt: '2025-04-15' },
        { id: 2, title: 'Literacy Tutorial Outreach Documentation (2024-2025 2nd Sem)', department: 'LTS', status: 'Approved', submittedAt: '2025-04-16' },
        { id: 3, title: 'Annual ROTC Tactical Briefing & Muster (2024-2025 2nd Sem)', department: 'ROTC', status: 'Approved', submittedAt: '2025-04-17' }
      ]
    }
  }
];
