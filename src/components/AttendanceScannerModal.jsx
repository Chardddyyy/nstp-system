            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-3">
              {completedDays.has(selectedDay) ? (
                <p className="text-xs font-bold text-rose-700 flex items-center gap-1.5">
                  ...
                  <span>Selected day already conducted. Please select another day.</span>
                </p>
              ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 p-3 sm:p-5 overflow-y-auto flex-1 bg-slate-100/60">
              ...
              <div className="space-y-3 flex flex-col justify-between">
                ...
                <div className="bg-white rounded-2xl p-3.5 border border-slate-200 shadow-xs flex-1 flex flex-col justify-between">
                  ...
                  {/* Close the Class Button */}
                  <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-2 flex-wrap">
                    <p className="text-[10px] text-slate-400">
                      * Attendance auto-saves upon scan. Click <b>Close the Class</b> when the session ends.
                    </p>
                    <button
                      type="button"
                      onClick={handleCloseClass}
                      disabled={isClosingClass}
                      className="px-4 py-2.5 bg-gradient-to-r from-rose-700 to-red-800 hover:from-rose-800 hover:to-red-900 text-white font-black text-xs rounded-xl shadow-md active:scale-95 transition-all flex items-center gap-1.5 cursor-pointer disabled:opacity-50 border border-rose-600/50"
